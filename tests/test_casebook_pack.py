"""Regression checks for the meridian-mesh-failure-forge casebook."""
...
from casebook.harness import assert_expected, meridian_mesh_failure_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_mesh_failure_forge_summary(), assert_expected())
